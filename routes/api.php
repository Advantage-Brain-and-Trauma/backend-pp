...
Route::middleware(['auth:api', 'role.api:User', 'patient.active'])->group(function (){
    ...
    Route::post('appointment-cancel/{userName}/{caseId}/{attendId}',[PatientAppointmentController::class, 'appointmentCancel']);
    ...
    Route::get('check-multiple-assign-funnel', [FunnelApiController::class, 'checkMultipleAssignFunnel']);
