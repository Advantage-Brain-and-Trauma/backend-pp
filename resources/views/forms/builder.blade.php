...
function renderPreviewField(field) {
  ...
  switch(field.type) {
    ...
    case 'image': wrap.innerHTML = `<label class="preview-label">${label}</label><div style="border:2px dashed var(--border);border-radius:9px;padding:28px;text-align:center;color:var(--text-muted);font-size:13px;background:var(--input-bg);cursor:pointer;">🖼 Click to upload image<br><span style="font-size:11px;">JPG, PNG, GIF, WEBP up to 10MB</span></div>`; break;
